...
gam_monthly_residuals_plots <- 
  map(sites, ~ create_residuals_plot(gam_monthly_residuals_data, .x))
...
gam_weekly_residuals_plots <- 
  map(sites, ~ create_residuals_plot(gam_weekly_residuals_data, .x))
...
gam_daily_residuals_plots <- 
  map(sites, ~ create_residuals_plot(gam_daily_residuals_data, .x))
