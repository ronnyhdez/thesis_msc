...
dataset and the calculated VIs. The models created are a daily, weekly, and a
monthly one to evaluate the predicting performance across different time scales. 



 - How many models? dauly weekly and monthly
 - variables
 - set up (folds, trees, resampling method stratification)
