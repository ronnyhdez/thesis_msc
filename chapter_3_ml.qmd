...
To understand which features were the most important to predict GPP from an 
individual observation and how the predictions values could change under 
different predictor values, we calculated the Shapley values [@lundberg_unified_nodate].
These values were computed for both low GPP and high GPP scenarios within each
of the temporally aggregated models. 
