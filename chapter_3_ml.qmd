...
#| message: false
#| warning: false
source("scripts/rf_preparation.R")
```
...
Moreover, in assessing the importance of predictor variables within each model,
...
significantly to the predictive performance in two of the models, the monthly and
weekly models (@fig-vip_monthly_500_rf and @fig-vip_weekly_500_rf). In the case
