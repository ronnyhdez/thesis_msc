...
employed two distinct modelling approaches: a Linear Model (LM) and a
Generalized Additive Model (GAM). GAM models allows a better fit for those cases
...
better explained by this type of model, that might not be optimal to capture
with a linear relationship, potentially leading to greater residuals. Both
model's approaches were applied individually to test our hypothesis regarding VI
