...
When considering the incorporation of all VIs as covariates, our models 
demonstrates enhanced predictive capabilities for the individual sites as well 
as when aggregating data from all three sites without differentiation. This
holds true for the 3 timeframes evaluated: monthly, weekly, and daily. In the
assessment of individual VI performance on a monthly basis, CCI tend to perform
better than EVI, NDVI, and NIRv. However it is important to note that for the 
Bartlett and Michigan sites, while CCI shows favourable predictive accuracy, its
advantage over the NIRv and EVI is slightly better and mostly due to the MAE
and RMSE results.
