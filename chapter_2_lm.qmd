...
#| fig-cap: "GPP trends from the study sites on a daily (a), weekly (b), and monthly (c) basis"
#| fig-width: 11
#| fig-height: 12
#| echo: false
#| message: false
...
: MOD09GA.061 MODIS Bands used to calculate the VIs {#tbl-MODIS_500_indices_bands}
...
Various methodologies were employed to estimate GPP by utilizing VIs and 
spectral bands derived from satellite images. The choice of model for GPP 
estimation varied depending on the specific time scale under consideration.
This approach aimed to enhance the accuracy of GPP estimation by employing 
models tailored to the characteristics of each time scale.
