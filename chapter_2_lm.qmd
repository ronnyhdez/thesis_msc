...
only inferred by the net carbon exchange measurements at the ecosystem level, or
at broarder scales using models that incorporate variour assumptions and
...
required to characterize these and improve accuracy. [@anav_spatiotemporal_2015;
@brown_fiducial_2021]
...
#| tbl-cap: "Summary of GAM models for GPP estimation using the vegetation indices on a monthly (a), weekly (b), and daily (c) basis." 
#| echo: false
#| message: false
#| warning: false
