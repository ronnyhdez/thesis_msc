...
for monthly results, @tbl-complete_lm_weekly_results for weekly results, and the
@tbl-complete_lm_daily_results for daily outputs.
...
the @tbl-gam_daily_model_results_complete_a, and @tbl-gam_daily_model_results_complete_b 
for daily models, @tbl-gam_weekly_model_results_complete_a, and 
...
@tbl-gam_monthly_model_results_complete_b
