...
[@gough_wood_2010], and a mean height of 2m. The mean annual temperature is
...
for the analysis. The number of high-quality surface reflectance observations was
...
significant of the model fits. All models add p-values \< 0.05 More metrics such
...
75%, MAE = $1.92 \, \mathrm{gC \, m^{-2} \, d^{-1}}$, RMSE =
...
RMSE for every individual VI model, while the aggregated sites category yield
