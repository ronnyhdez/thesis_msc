...
its performance, as measured by the GPP RMSE, was comparatively less favorable on
...
This observation holds significance as, despite VIs serving as
...
to capture the non-linear nature of the relationship. A selection of a
proficient VI with a non-linear model could better estimate GPP without the need
of creating models with multiple predictors. In this scenario, the GAM model
