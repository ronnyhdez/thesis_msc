...
Nonetheless, while estimating GPP from satellite remote sensing methods is
...
seasons and locations. Therefore, there is a need to validate and improve their
accuracy [@anav_spatiotemporal_2015; @brown_fiducial_2021]. In-situ
eddy-covariance flux measurements coupled with locally calibrated models for
respiration [@baldocchi_how_2020] represent a a suitable reference GPP for
validation solution given that they represent site-level observations
