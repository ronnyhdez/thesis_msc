...
Bartlett, compared with those of Borden, reveals notably wider data ranges,
...
[@lin_evaluating_2019] showed that Chlorophyll Index Red (CRI) had a better
correlation with GPP, or CCI for evergreen conifers [@gamon_remotely_2016].

The application of linear models, incorporating all VIs as covariates on a
monthly basis, produced favourable outcomes in both model fit and residual
metrics. This observation holds significance as, despite VIs serving as
...
monthly to weekly and, subsequently, to daily values (See @fig-lm_residuals for
LM residuals and @fig-gam_residuals for GAM residuals). Although the decrease in
...
time aggregation. Moreover, the impact of large variations in GPP ranges within
a site is evident in the quality of predictions. These variations introduce
complexities and uncertainties, emphasizing the necessity of accounting for
local site characteristics and inherent heterogeneity when aiming for accurate
predictions of GPP. Growing seasons exhibit the most pronounced variability,
posing challenges for vegetation indices that saturate at high biomass
concentrations, making it more difficult to track changes in GPP.
