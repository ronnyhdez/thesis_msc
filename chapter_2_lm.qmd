...
All sites have similar characteristics among them, making them comparable and
also usable as a representation of an specific type of ecosystem which can 
provide insights about the GPP and its relation with VIs. A summary of the
characteristics is in @tbl-site_summary


| Variable  | Bartlett  | Michigan | Borden |
| --------- | --------- | -------- | ------ |
| Mean annual temperature | 5.6 | 5.8 | 7.4 |
| Mean annual precipitation | 1,246 | 803 | 784 |
| Elevation | 272 | 234 | 209 |
| Dominant genera | Acer, Fagus, Betula | Populus, Quercus, Pinus | Acer, Pinus Populus |
| Climate Koeppen | Dfb | Dfb | Dfb |

: ONEFlux summary of the sites characteristics {#tbl-site_summary}
...
performance of the models we calculated the coefficient of determination (R²),
