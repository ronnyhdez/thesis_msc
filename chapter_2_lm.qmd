...
significant of the model fits. All models add p-values < 0.05More metrics such as the p-value, adjusted
...
different VIs allows to use of a LM to capture non-linear patterns throughout
