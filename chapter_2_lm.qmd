...
statistics, such as r-squared, adjusted r-squared, and root mean square error 
(RMSE). More metrics such as the p-value, the Akaike Information Criterion (AIC)
and Bayesian Information Criterion (BIC) are dispalyed in the
