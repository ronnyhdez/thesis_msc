...
lm_metrics_plots <- plot_grid(monthly_metrics_plots[[1]] + theme(legend.position = "none"),
...
gpp_trends <- plot_grid(lm_metrics_plots, plot_legend, ncol = 2, rel_widths = c(1, .1))
rm(plot_legend)
```
