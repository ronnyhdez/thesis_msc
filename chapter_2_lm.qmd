...
@tbl-complete_lm_daily_results for daily outputs. A residuals distribution 
for each of the models is in @fig-lm_residuals
...
@tbl-gam_monthly_model_results_complete_b. A residuals distribution 
for each of the models is in @fig-gam_residuals
...
illustrated in @fig-gam_metrics and @fig-lm_metrics.
