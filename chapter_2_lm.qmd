...
performance demonstrates better outcomes compared to using any single index 
...
up to 20% in the variability explanation.Bartlett and Michigan sites 
independently yielded the most accurate predictive models.

On a daily basis, CCI specifically for the Bartlett, Borden, and the combined 
sites dataset, with Borden slightly outperforming the others by a margin of 1% 
in variance explanation. In the case of Michigan, the best individual index 
was EVI which outperformed the next best-performing individual index NIRv by 3%.
Across all scenarios, the incorporation of all vegetation indices as covariates 
consistently contributed to enhanced model performance. Generally, the Bartlett 
...
In general terms, across the timeframes, CCI consistently performed better than
any other individual index in terms of variance explanability and errors, but
the differences were not that big compared with EVI and NIRv. On the other
hand, NDVI performed worst across all timeframes in most cases. When using the 
monthly values models had a better performance outcome than a weekly or daily
basis.
