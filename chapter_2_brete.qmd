...
For the linear models, the ...

 - ndvi lo hace peor en 2 de 3
 - entre cada sitio no hay mucha diferencia
 - bartlett es el que tiene mejores rsquares
...
#| tbl-cap: "Linear models for all sites at 500m"
#| echo: false
#| message: false
#| warning: false
# Create table
bind_rows(evi_glance,
          ndvi_glance,
          nirv_glance) %>% 
  select(site, index, r.squared, adj.r.squared, statistic, p.value, AIC, BIC) %>% 
  group_by(site) %>% 
