...
daily_500_rf_test <- daily_500_rf %>%
  select(-site)

set.seed(123)
daily_500_split <- initial_split(daily_500_rf_test)
...
# To check the predictions with all original values from the dataset
# broom::augment(daily_500_fit)
...
imp_spec <- ranger_spec %>%
  finalize_model(select_best(daily_500_fit)) %>%
